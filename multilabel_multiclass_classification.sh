...
prompts_file_path="prompts/classification/multilabel_multiclass_classification.yaml"
method_type="multilabel_multiclass"
...
run_script() {
    ...
    output_file="benchmark_results/$model/$parent_dir/intention_multilabel_multiclass.csv"
